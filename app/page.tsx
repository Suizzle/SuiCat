...
export default function Home() {
  ...
  const[suiCatVid, setSuiCatVid] = useState(placeHolderVid);
  ...
  async function downloadVideo() {
    let digest = document.getElementById("vidPtbId") as HTMLInputElement;
    let digestValue = digest.value;
    try {
      let res = await client.getTransactionBlock({
        digest:  digestValue,
      ...
      const buffer = Buffer.from(inputbytes);
      const base64String = buffer.toString('base64');
      setSuiCatVid("data:"+parsedData.mime+";base64,"+base64String); 

      console.log(suiCatImg);
    } catch (e) {
      console.log(e);
    }
  }
    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="relative flex place-items-center before:absolute before:h-[300px] before:w-full sm:before:w-[480px] before:-translate-x-1/2 before:rounded-full before:bg-gradient-radial before:from-white before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-full sm:after:w-[240px] after:translate-x-1/3 after:bg-gradient-conic after:from-sky-200 after:via-blue-200 after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-blue-700 before:dark:opacity-10 after:dark:from-sky-900 after:dark:via-[#0141ff] after:dark:opacity-40 before:lg:h-[360px] z-[-1]">
        ...
        <video width="320" height="240" loop autoPlay>
          <source src={suiCatVid} type="video/mp4" />
      ...
      <div className="mb-32 grid text-center ">
        ...
        <input id="vidPtbId" type="text" placeholder="Enter noop video transaction block ID"></input>
